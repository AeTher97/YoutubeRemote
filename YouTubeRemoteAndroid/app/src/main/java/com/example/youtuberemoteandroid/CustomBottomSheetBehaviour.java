...
public class CustomBottomSheetBehaviour<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public CustomBottomSheetBehaviour(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, @NonNull CustomBottomSheetBehaviour<?> behavior) {
            super(superState);
    ...
    public static <V extends View> CustomBottomSheetBehaviour<V> from(@NonNull V view) {
